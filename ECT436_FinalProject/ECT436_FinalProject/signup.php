    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
						<h2 class="intro-text text-center"><strong>Signup For an Account Page</strong></h2>
                    <hr>
                </div>
			<form id="signupform" method="post" action="search_filter.php">
                <div id="myfield" class="col-md-6">
					<label>First Name:</label>
					&nbsp;<input class="required" type="text" name="fname" title="Please enter your First Name"/>
					<br /><br />
					<label>Last Name:</label>
					&nbsp;<input class="required" type="text" name="lname" title="Please enter your Last Name" />
                </div>
                <div id="secondfield" class="col-md-6">
