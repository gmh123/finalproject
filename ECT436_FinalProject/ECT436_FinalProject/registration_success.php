...
<body>
<div id="login">
	<button type='submit' class='btn btn-primary mybtn' onclick='loginCookie()'><a href="login.php">LOGIN</a></button>
</div>
<div id="logout">
	<button type="button" class="btn btn-primary mybtn" onclick="logoutCookie()">LOGOUT</button>
</div>
	<button type="submit" class="btn btn-secondary secondbtn"><a href="signup.php">SIGNUP</a></button>
        ...
        <div class="container">
			...
			<div class="collapse navbar-collapse myMenu" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li><a href="login.php">Assignment 4</a></li>
